...
%    \draw[->, shorten >=-1.0mm] ($(cs.east)!.0!(cs.north east)$) -- (out.west);
    ...
    \draw[->, shorten >=-1.0mm] (mem.south) to node[right, align=left]{\footnotesize Machine \\ \footnotesize Instructions} (cs.north);

    \draw[->, shorten >=-1.0mm] ($(cs.west)!.5!(cs.south west)$) to [out=225, in=165] (alu.west);
