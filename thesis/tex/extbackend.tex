...
\section{Reload}
As hinted in section \ref{sec:methreload} |reload| is a deprecated process in GCC that mainly performs register allocation.
...
We explained the basics of insn definition earlier in section \ref{section:insn} thus we will only explain specific for this insn.
