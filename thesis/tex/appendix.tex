...
\begin{table}[!htbp]
    \caption{\label{tab:builtinlist} List of all implemented built-ins and how they are used. The suffix {\tt fs} or {\tt f} represents fractional saturation instructions and {\tt m} modulo instructions.}
        ...
        \begin{tabular}{c c¡c¡c¡c¡c¡p{5cm}}
            ...
            \cline{3-6}
                ...
                \begin{tabular}[x]{@{}c@{}} |vector signed char|\\
                                            ...
                                            |vector signed short|\\
                                            |vector unsigned short|\end{tabular}
                                            & |int| & \phantom{{\tt vector unsigned short}} & |d| is read from synaptic address |a + b|\\ 
            \cline{3-6}
