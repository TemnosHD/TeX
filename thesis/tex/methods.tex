...
The PPU, which was designed by Simon Friedmann \cite{PPU}, is a custom processor in this system, that is based on the Power Instruction Set Architecture (PowerISA), which was developed by IBM since 1990. 
...
\begin{figure}
    ...
    \noindent{\begin{minipage}{\textwidth}
        \begin{minipage}[c][][c]{0.25\textwidth}
            \begin{tcolorbox}[enhanced, height=1cm, width=\linewidth, remember as=pp, opacityframe=0.0, opacityback=0.0]
            \end{tcolorbox}
            \begin{tcolorbox}[tcbox raise base, width=\linewidth, remember as=cp, enhanced, watermark text=Compiler]
                ...
                \end{tcolorbox}
            \end{tcolorbox}
            \begin{tcolorbox}[height=1cm, width=\linewidth, remember as=as, opacityframe=0.0, opacityback=0.0]
            \end{tcolorbox}
            \begin{tcolorbox}[height=1cm, width=\linewidth, remember as=lk, opacityframe=0.0, opacityback=0.0]
            \end{tcolorbox}
            \begin{tcolorbox}[height=1cm, width=\linewidth, remember as=ld, opacityframe=0.0, opacityback=0.0]
            \end{tcolorbox}
            \begin{tikzpicture}[overlay,remember picture,line width=1mm]
                \draw[->] ($(pp.north)+(0,1)$) -- node [left] {program code} (cp.north);
                \draw[->] (cp.south) -- node [left] {machine files} ($(ld.south)+(0,-1)$);
            \end{tikzpicture}
        \end{minipage}
        \begin{minipage}[c][][c]{0.25\textwidth}
            \begin{tcolorbox}[enhanced, height=1cm, width=\linewidth, watermark text=Preprocessor, remember as=pp]
                \hfill
            \end{tcolorbox}
            \begin{tcolorbox}[tcbox raise base, width=\linewidth, remember as=cp, enhanced jigsaw]
            ...
            \end{tcolorbox}
            \begin{tikzpicture}[overlay,remember picture,line width=1mm]
                \draw[->] ($(pp.north)+(0,1)$) -- node [left] {program code} (pp.north);
                \draw[->] (pp.south) -- (fe.north);
                \draw[->] (fe.south) -- (me.north);
                \draw[->] (me.south) -- (be.north);
                \draw[->] (be.south) -- (as.north);
                \draw[->] (as.south) -- (lk.north);
                \draw[->] (lk.south) -- (ld.north);
        ...
        \begin{minipage}[c][][c]{0.4\textwidth}
            ...
            \end{tcolorbox}
            \begin{tikzpicture}[overlay,remember picture,line width=1mm]
                \draw[->] ($(cp.north)+(0,1)$) -- (sc.north);
                \draw[->] (sc.south) -- (ps.north);
                \draw[->] (ps.south) -- (sa.north);
                \draw[->] (sa.south) -- (sco.north);
                \draw[->] (sco.south) -- (me.north);
                \draw[->] (me.south) -- (cg.north);
                \draw[->] (cg.south) -- (tco.north);
