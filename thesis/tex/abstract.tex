...
This architecture is also capable of parforming additional tasks in experiments.
...
First tests of the extended back-end have been successful and already pinned down bugs in the current processor, which could be worked around.
...
Das Brainscales Wafersystem ermöglicht beschleunigtes analoges neuromorphes Rechnen mit fest eigebauten synaptischen Plastizitätsregeln.
Der Prototyp für die nächste Generation des Systems (HICANN-DLS) verwendet einen programmierbaren Plasitzitätsprozessor, der zukünftig verschiedenste Plastitzitätsregeln ermöglichen soll.
...
Das ermöglicht schnelle und flexible Platizitätsregeln während eines Experiments.
Zusätzlich ist der Prozessor in der Lage weiter Aufgaben in Experimenten zu übernehmen.

In dieser Bachelorarbeit wird die Anpassung der \acf{GCC} Back-Ends für diese Architektur beschrieben.
