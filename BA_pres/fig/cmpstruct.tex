...
\begin{tcolorbox}[height=0.7cm, width=\linewidth, watermark text=Assembler, remember as=as, enhanced jigsaw, noparskip]
\end{tcolorbox}

\begin{tcolorbox}[height=0.7cm, width=\linewidth, watermark text=Linker, remember as=lk, enhanced]
\end{tcolorbox}

\begin{tcolorbox}[height=0.7cm, width=\linewidth, watermark text=Loader, remember as=ld, enhanced]\end{tcolorbox}
