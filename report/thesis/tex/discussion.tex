...
We leave further explanation of the internals of GCC to the official GCC internals handbook \todo{add link} as it provides a more detailed look into RTL and insn defintion.
